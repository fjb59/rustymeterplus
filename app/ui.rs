                    ...
                    match self.connection_state {
                        super::ConnectionState::Disconnected => {
                            if ui.button("Connect").clicked() {
                                ...
                                if  self.serial_port.parse::<Ipv4Addr>().is_ok()
                                {
                                ...
                                else 
                                {
                                    ...
                                    let addrs =self.serial_port.to_socket_addrs();
                                    if addrs.iter().count() >0
                                    {
                                        let  addrs_iter = addrs.unwrap();
                                        for val in addrs_iter
                                        {
                                ...
                                if self.connection_type == ConnectionType::None
                                {
